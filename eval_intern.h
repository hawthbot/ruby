...
#define CREF_FL_DYNAMIC_SINGLETON IMEMO_FL_USER4
...
static inline int
CREF_DYNAMIC_SINGLETON(const rb_cref_t *cref)
{
    return cref->flags & CREF_FL_DYNAMIC_SINGLETON;
}

static inline void
CREF_DYNAMIC_SINGLETON_SET(rb_cref_t *cref)
{
    cref->flags |= CREF_FL_DYNAMIC_SINGLETON;
}
